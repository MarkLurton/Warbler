...
def profile():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            user.bio = form.bio.data  if len(form.bio.data) > 0 else "Fellow Warbler"
            user.location = form.location.data if len(form.location.data) > 0 else "None"
